...
from ..gym.surrol_goalenv import SurRoLGoalEnv
from ..robots.psm import Psm1, Psm2
...
from ..const import ROOT_DIR_PATH, ASSET_DIR_PATH
...
class PsmEnv(SurRoLGoalEnv):
    ...
    def compute_reward(self, achieved_goal: np.ndarray, desired_goal: np.ndarray, info):
        ...
        print("this is the old reward", self._is_success(achieved_goal, desired_goal).astype(np.float32) - 1.)
    ...
    def _get_obs(self) -> dict:
        ...
        observation = np.concatenate([
            ...
            waypoint_pos.ravel(), waypoint_rot.ravel(), self.goal.copy(), achieved_goal.copy()  # achieved_goal.copy(),
        ])
        # obs = {
