...
from vlmrm.envs.surrol.surrol_goalenv import SurRoLGoalEnv
from vlmrm.envs.surrol.robots.psm import Psm1, Psm2
from vlmrm.envs.surrol.utils.pybullet_utils import (
    get_link_pose,
    wrap_angle,
    reset_camera
)
from vlmrm.envs.surrol.utils.robotics import (
    get_euler_from_matrix,
    get_matrix_from_euler
)
from vlmrm.envs.surrol.utils.const import ROOT_DIR_PATH, ASSET_DIR_PATH
...
class PsmEnv(SurRoLGoalEnv):
    ...
    def get_keyboard_action(self, obs) -> np.ndarray:
